...
| 至少 5 個分級排序問題 | `usability_issue_backlog.md` U-01～U-09 | 數量符合 | U-01～U-05 是啟發式／功能問題，真人問題為 U-06～U-09；報告時需清楚區分 |
...
| GitHub 文件、版本與證據 | README 有基準提交、成果連結與非真人功能證據 | 待最終提交 | 完成驗證後建立清楚提交並把實際提交識別回填 README |
