...
| 原問題或新情境 | `ApplicationService.updateStatus` 未檢查目前狀態，已核准申請可改為待補件或已退回；此回轉規則尚待 FR-08 確認 |
...
| 可觀察結果 | 目前 IST-01 顯示實作接受已核准→待補件；確認 FR-08 後再決定應接受或拒絕 |
| 狀態變化 | 候選：待審核→已核准；未定義：已核准→待補件，兩者均須以 FR-08 確認結果為準 |
